						...
						<div class="card-body">
							<form action="{{url('admin/addphong')}}" method="POST" class="form-horizontal">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										<input id="inputHorizontalSuccess" name="tenphong" type="text" placeholder="Tên Phòng"  class="form-control form-control-success"><small class="form-text text-muted ml-3">Chú ý : .</small>
									</div>
								</div>
								<div class="form-group row">       
